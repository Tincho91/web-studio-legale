...
const Citadinanza: FC = () => {
  const t = useTranslations('ServiziPage');

  return (
    <div className="relative pb-10 md:pb-auto bg-gradient-repeating z-0 overflow-x-hidden">
      <div className="absolute top-0 left-0 right-0 h-[250px] bg-cover bg-center z-0 bg-[url('/images/sellBanner.png')]"></div>
